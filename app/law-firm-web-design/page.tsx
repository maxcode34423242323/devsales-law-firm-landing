...
export default function LawFirmWebDesignPage() {
  ...
  return (
    <main className="law-page">
      ...
      <a href="tel:+13155478952" className="law-sticky-call"><ContactIcon type="phone" /><span>Call now: 315-547-8952</span></a>
