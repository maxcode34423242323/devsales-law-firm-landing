  ...
  return (
    <main className="law-page overflow-hidden">
      ...
      <style jsx global>{`
        ...
        .law-mobile-overlay{position:fixed;inset:0;z-index:60;background:rgba(5,0,20,.6);-webkit-backdrop-filter:blur(4px);backdrop-filter:blur(4px)}.law-mobile-drawer{position:absolute;right:0;top:0;display:flex;height:100%;width:min(340px,86vw);flex-direction:column;background:#150a3b;padding:26px 22px;box-shadow:-30px 0 80px rgba(0,0,0,.4)}.law-drawer-top{display:flex;align-items:center;justify-content:space-between}.law-drawer-top button{width:36px;height:36px;border-radius:50%;background:rgba(255,255,255,.08);color:#fff;font-size:20px}.law-drawer-links{display:flex;flex-direction:column;gap:4px;margin-top:40px}.law-drawer-links a{padding:16px 4px;border-bottom:1px solid rgba(255,255,255,.1);color:rgba(255,255,255,.85);font-size:18px}.law-drawer-cta{display:flex;align-items:center;justify-content:center;min-height:54px;margin-top:auto;border-radius:999px;background:linear-gradient(90deg,#a79fbc,#d0c9df);color:#32127a;font-size:12px;font-weight:700;letter-spacing:.08em;text-transform:uppercase}
