...
export default function LawFirmWebDesignPage() {
  ...
  return (
    <main className="law-page">
      ...
      <section className="law-section">
        <div className="law-container">
          <motion.div {...reveal} className="law-section-head"><div><p className="section-kicker">[ Client feedback ]</p><h2>What clients say after launch.</h2></div><p>Real feedback from clients we&apos;ve built websites for.</p></motion.div>
